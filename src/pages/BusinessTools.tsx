...
// --- Main Business Tools Component ---
export const BusinessTools = () => {
  // --- State to manage which tool is active in the toggle ---
  const [activeTool, setActiveTool] = useState('accountant');
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <LampContainer>
        ...
        >
          A powerful suite of AI-driven tools to automate tasks, save time, and grow your business.
        </motion.p>
      </LampContainer>
